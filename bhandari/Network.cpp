...
void Network::init () {
	...
	for (int a = 0; a < NumofNodes; a++) {
		for (int b = 0; b < NumofNodes; b++) {
			cout << "***** ";
			cout << "SRC é: " << a + 1 << " e DEST é: " << b + 1 << endl;
	...
	// Inicialização da matriz de recursos
...
void Network::simulation () {
	...
	while (!eventQueue->ev_Queue.empty ()) {
		...
		cout << "Imprssão da chave do evento na fila" << endl;
	...
	cout << "Impressão do ID dos eventos das solicitações bloqueadas" << endl;
	...
	cout << "Nº máximo de transponders usados: " << MaxNumofTransponders << endl;
	cout << "Número máximo de seções usadas para cada solicitação: " << MaxNumofSections << endl;
	cout << "# de solicitações bloqueadas é " << NumofFailedRequests << endl;
	cout << "Carga da rede: " << Lambda / Mu << " Erlang" << endl; 
	cout << "Probabilidade de Bloqueio: " << (double) NumofFailedRequests / (double) NumofRequests << endl;
	cout << "Média de nucleos usados por solicitação: " << AvgCoresUsed << endl;
	cout << "Média de transponders usados por solicitação: " << AvgTranspondersUsed << endl;
	cout << "Tempo medio de retenção por solicitação: " << AvgHoldingTime << endl;
	cout << "GuardBand medio por requisição: " << AvgGBUsed << endl;
	cout << "Média de Fragmentação interna: " << AvgIntFrag << endl;
	cout << "Média de Fragmentação externa: " << AvgExtFrag << endl;
	cout << "Média de Fragmentação hibrida: " << AvgHybridFrag << endl; 
}
